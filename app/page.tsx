...
export default function HomePage() {
  return (
    <div className="max-w-[var(--max-width)] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-12 sm:space-y-16">
      ...
      <section className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-8 sm:p-12 lg:p-16 text-center">
        ...
        <div className="relative z-10 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/signup"
              className="w-full sm:w-auto px-8 py-3 bg-accent hover:bg-accent-hover text-white rounded-xl font-medium transition-all text-sm"
            >
              Create Free Account
            </Link>
            <Link
      ...
      <Link
        href="/contact"
        className="fixed bottom-6 right-6 w-14 h-14 bg-accent hover:bg-accent-hover text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 z-30"
        aria-label="Contact"
      >
